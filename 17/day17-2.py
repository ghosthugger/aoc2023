...
def child(m,x,y,dir):
    ...
    #    el
    if dir=='v' or dir=='^':
        stepsl=[(1,0) for i in range(1,11)]
        stepsr=[(-1,0) for i in range(1,11)]
        d90='>'
    if dir=='<' or dir=='>':
        stepsl=[(0,-1) for i in range(1,11)]
        stepsr=[(0,1) for i in range(1,11)]
        d90='v'
...
def main():
    ...
    # print("g[(10,10,'>')]")
    # print(g[(10,10,'>')])
    r=dijkstra(g,((0,0,'v')))  #or start with >
    print(r)
